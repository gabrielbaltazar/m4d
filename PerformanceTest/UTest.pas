...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.StdCtrls, M4D.Defaults;
...
procedure TForm2.ExecutarPelaInterface(AClass: TClass);
var
  Aux: TObject;
begin
  Aux := AClass.Create;
...
procedure TForm2.ExecutarPelaRTTI(AClass: TClass);
var
