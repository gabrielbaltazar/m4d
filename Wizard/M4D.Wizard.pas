...
//    bmp.LoadFromFile(PathFile);
    SplashScreenServices.AddPluginBitmap('M4D', bmp.Handle);
  finally
    bmp.Free;
  end;
end;
...
const
  sSource = 'unit MMigration1;                                          ' + Chr(10) + Chr(13) +
            ...
            '    function UpWillExecute: Boolean; override;             ' + Chr(10) + Chr(13) +
            '    function DownWillExecute: Boolean; override;           ' + Chr(10) + Chr(13) +
            '  end;                                                     ' + Chr(10) + Chr(13) +
            '                                                           ' + Chr(10) + Chr(13) +
            ...
            'end;                                                       ' + Chr(10) + Chr(13) +
            '                                                           ' + Chr(10) + Chr(13) +
            'function TMyNewMigration1.UpWillExecute: Boolean;            ' + Chr(10) + Chr(13) +
            'begin                                                      ' + Chr(10) + Chr(13) +
            '  Result := True;                                          ' + Chr(10) + Chr(13) +
            'end;                                                       ' + Chr(10) + Chr(13) +
            '                                                           ' + Chr(10) + Chr(13) +
            'function TMyNewMigration1.DownWillExecute: Boolean;          ' + Chr(10) + Chr(13) +
            'begin                                                      ' + Chr(10) + Chr(13) +
            '  Result := True;                                          ' + Chr(10) + Chr(13) +
            'end;                                                       ' + Chr(10) + Chr(13) +
            '                                                           ' + Chr(10) + Chr(13) +
